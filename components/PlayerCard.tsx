...
export default function PlayerCard({ player, rank, isTop3, animationIndex }: PlayerCardProps) {
  ...
  if (isTop3) {
    ...
    return (
      <div className={`lb-card lb-card-top3 ${glowClass} fade-up px-2.5 sm:px-5 py-3 overflow-hidden`} style={{ animationDelay: `${animationIndex * 40}ms` }}>
  ...
  return (
    <div className="lb-card glow-orange fade-up px-2.5 sm:px-4 py-2.5 overflow-hidden" style={{ animationDelay: `${animationIndex * 30}ms` }}>
