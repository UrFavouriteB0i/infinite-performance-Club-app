...
export const revalidate = 0; // Or ISR revalidation interval
...
export default async function LeaderboardPage() {
  ...
  // Instant server render with initial data, zero client layout shifts
  return <LeaderboardView initialPlayers={initialPlayers} />;
}
